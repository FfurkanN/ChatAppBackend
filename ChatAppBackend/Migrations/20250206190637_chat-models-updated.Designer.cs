...
namespace ChatAppBackend.Migrations
{
    ...
    [Migration("20250206190637_chat-models-updated")]
    partial class chatmodelsupdated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatAppBackend.Models.AppUser", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("Chats")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ChatAppBackend.Models.AppMessage", b =>
                {
                    b.HasOne("ChatAppBackend.Models.AppChat", null)
                        .WithMany("Messages")
                        .HasForeignKey("AppChatId");
                });
